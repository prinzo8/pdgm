...
<section id="conseils" class="section section-pad advice-section"><div class="container"><div class="section-heading reveal"><p class="eyebrow">05 — Conseils santé</p><h2>Quelques repères<br><em>pour chaque jour.</em></h2></div><div class="advice-grid"><article class="advice-card reveal"><span>01 / prévention</span><h3>Demander conseil, c’est déjà prendre soin de soi.</h3><p>Pour tout nouveau médicament ou toute question, demandez l’avis d’un professionnel de santé.</p></article><article class="advice-card advice-card-accent reveal reveal-delay"><span>02 / quotidien</span><h3>Hydratation, repos, régularité.</h3><p>De petits gestes simples soutiennent votre bien-être jour après jour, en complément d’un suivi adapté.</p></article><article class="advice-card reveal reveal-delay-2"><span>03 / sécurité</span><h3>Bien utiliser ses médicaments.</h3><p>Respectez la posologie prescrite et ne partagez jamais un traitement sans avis médical.</p></article></div><p class="disclaimer">Ces informations sont générales et ne remplacent pas un avis médical personnalisé.</p></div></section>
...
</div><div class="location-copy reveal reveal-delay"><p class="eyebrow">06 — Localisation</p><h2>Au cœur de<br><em>San Pedro.</em></h2><p class="address"><strong>Pharmacie du Grand Marché</strong><br><?php echo nl2br( esc_html( $c['address'] ) ); ?><br><?php echo esc_html( $c['city'] ); ?></p><div class="hero-actions"><a class="button button-primary" href="<?php echo esc_url( $c['maps_url'] ); ?>" target="_blank" rel="noopener">Ouvrir Google Maps <span class="maps-cta-icon" aria-hidden="true"><svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l-6 3V6l6-3 6 3 6-3v15l-6 3-6-3z"></path><path d="M9 3v15"></path><path d="M15 6v15"></path></svg></span></a></div><p class="coordinates">Repère cartographique public · 4.77863, −6.65600</p></div></div></section>
<section id="contact" class="section contact-section section-pad"><div class="container contact-layout"><div class="contact-intro reveal"><p class="eyebrow">07 — Contact</p><h2>Une question ?<br><em>Nous sommes là.</em></h2><p>Pour confirmer les horaires, la disponibilité d’un produit ou l’itinéraire, choisissez le moyen le plus simple pour vous.</p></div><div class="contact-actions reveal reveal-delay"><a class="contact-action" href="<?php echo esc_attr( $phone_href ); ?>"><span class="contact-icon">☎</span><span><small>Appeler</small><strong><?php echo esc_html( $c['phone'] ); ?></strong></span></a><?php if ( $wa_href ) : ?><a class="contact-action" href="<?php echo esc_url( $wa_href ); ?>" target="_blank" rel="noopener"><span class="contact-icon contact-icon-whatsapp" aria-hidden="true">
...
</span><span><small>WhatsApp</small><strong>Écrire à la pharmacie</strong></span></a><?php endif; ?><a class="contact-action" href="<?php echo esc_url( $c['maps_url'] ); ?>" target="_blank" rel="noopener"><span class="contact-icon">⌖</span><span><small>Adresse</small><strong>Grand Marché · San Pedro</strong></span></a></div></div></section>
<?php get_footer(); ?>
